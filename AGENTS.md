...
This project is indexed by GitNexus as **Ziggy_PC** (8440 symbols, 16015 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
