...
const NotesManager = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mb-6">
        <div className="mb-4">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Notes Manager</h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <div className="flex items-center">
          ...
          {filteredNotes.length !== notes.length && (
            <div className="ml-8">
              <p className="text-lg font-semibold text-blue-600 dark:text-blue-400">{filteredNotes.length}</p>
      ...
      {filteredNotes.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredNotes.map((note) => (
            <div key={note.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
      ...
      <div className="bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-green-900 dark:text-green-200 mb-2">📝 Notes Tips</h3>
