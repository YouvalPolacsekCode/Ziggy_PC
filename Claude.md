...
This project is indexed by GitNexus as **Ziggy_PC** (7820 symbols, 15187 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
